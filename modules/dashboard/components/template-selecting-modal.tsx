...
const TemplateSelectionModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto border border-black">
        {step === "select" ? (
          <>
            <DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative flex p-6 border border-black rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                          ${
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto">
                              {template.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="text-xs px-2 py-1 border border-black rounded-2xl"
                                >
                                  {tag}
                                </span>
                              ))}
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border border-black">
